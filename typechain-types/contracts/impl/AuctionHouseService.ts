...
export interface AuctionHouseServiceInterface extends utils.Interface {
  functions: {
...
export interface AuctionHouseService extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AuctionHouseServiceInterface;
  ...
  functions: {
    ...
    infoHistory(
      arg0: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[string, BigNumber] & { hash: string; timestamp: BigNumber }>;
